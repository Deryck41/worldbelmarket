<? include "/asted/templates/header.php"; ?>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="products">
                        ...
                        <div class="row">
                            ...
                            <div class="col-1">
                                <div class="personal_divisions-icon">
                                    <i class="fas fa-fw fa-trash trashclick" onclick="Delete(<?= $id ?>,'catalog')" value="<?= $id ?>" style="float: right;"></i> <a href="/asted/catalog-edit/<?= $id ?>/"><i class="fas fa-fw fa-edit" data-toggle="modal" data-target="#myModalka<?= $id ?>" style="float: right;"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                if ($startRange > 1) {
                    echo '<li class="page-item"><a class="page-link" href="/asted/catalog/' . $_GET["id"] . '/1/">1</a></li>';
                    if ($startRange > 2) {
                ...
                for ($page = $startRange; $page <= $endRange; $page++) {
                    ...
                    echo '<li class="page-item ' . $activeClass . '"><a class="page-link" href="/asted/catalog/' . $_GET["id"] . '/' . $page . '/">' . $page . '</a></li>';
                }
                if ($endRange < $totalPages) {
                    if ($endRange < $totalPages - 1) {
                        echo '<li class="page-item disabled"><span class="page-link">...</span></li>';
                    }
                    echo '<li class="page-item"><a class="page-link" href="/asted/catalog/' . $_GET["id"] . '/' . $totalPages . '/">' . $totalPages . '</a></li>';
                }
                echo '</ul></div>'; ?>
            </div>
...
<? include "/asted/components/site.modalImageAll/modalImg.php"; ?>
<? include "/asted/templates/footer.php"; ?>
<script src="/asted/components/site.modalImageAll/script.js" type="module"></script>
<script>
    ...
    function search() {
        ...
        jQuery.ajax({
            url: '/asted/components/site.catalog/search.php',
            type: 'POST',
            data: {
                input_value
            },
