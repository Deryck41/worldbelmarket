    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          Поздравляем с установкой <strong></strong><br><br>
          <hr>
...
<body id="page-top">
  ...
  <? if ($cofigius['0']['construct'] == "on") { ?>
    <div class="construct_body">
      ...
      <h3 class="terran_const_control" style="float: right;    margin-right: 75px;">Construct</h3><br><br>
                ...
                <ul class="navbar-nav ml-auto template_bg headerbar_right">
                  ...
                  <?php if ($numRowsalertcount != null) { ?> <li class="nav-item dropdown no-arrow mx-1">
                      ...
                      <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                        ...
                        <a class="dropdown-item text-center small text-gray-500" href="/panel/notice/">Показать всё оповещения</a>
                      </div>
                    </li><? } ?>
                ...
                <a class="dropdown-item d-flex align-items-center" href="<?php if(!empty($notice->uri)){echo $notice->uri;}else{echo '#';} ?>">
                  <div class="dropdown-list-image mr-3">
                    <?php   if ($cofigius['0']['constpalitretheme'] == "dark") { ?>
                      <img class="rounded-circle" src="/panel/templates/img/logo-white.png" style="width: 30px;filter: drop-shadow(1px 1px 20px red) invert(75%);" alt="">
                      <?}else{?>
                    <img class="rounded-circle" src="/panel/templates/img/logo-white.png" alt="">
                    <?}?>
...
<?}?>
                <a class="dropdown-item text-center small text-gray-500" href="/panel/notice/"><?= $lang['show_all_messages'] ?></a>
              </div>
            </li>
            ...
            <?}?>
                  ...
                  <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                      ...
                      <a class="dropdown-item" href="/panel/tasks-trash/">
                        <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>
                        <?= $lang['deleted_tasks'] ?>
                      </a>
