...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			...
			<?php if ($type == "code") { ?>
				<div class="alert alert-danger">ВНИМАНИЕ: Данная страница имеет уникальнкую структуру дизайна и использует логический код-астед, и редактируется только через контетные блоки либо через шаблон (обратитесь к разрабочику), при этом вы можите менять остальные значения страницы
				<a href="/panel/content/<?=$idcustom?>/">редактировать страницу</a>.
				</div>
			<? } ?>
