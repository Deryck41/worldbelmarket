...
<link rel="stylesheet" href="/panel/components/site.payment/style.css">
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="search-panel">
                <select name="moderation" class="filter-select">
...
<script src="/panel/components/site.payment/script.js"></script>
