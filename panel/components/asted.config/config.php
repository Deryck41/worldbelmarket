...
<span class="badge badge-pill badge-success">Конфигурация системы задана при установке и не менялась</span>
                           ...
                           if($dirConfig == 'admin'){?>
<br><strong>Тип конфигурации:</strong> Для уравления сайтом (лежит в доп дериктории <span class="typeinf"><?=$urls[1]?></span>)
                           <? }?>
                           <?php if($dirConfig == 'main'){?>
<br><strong>Тип конфигурации:</strong>Для уравления CRM системой (лежит в корне) 
                           <? }
                        ?>
						...
						<hr>
																		<label for="exampleInputPassword1">Система сайта CWS</label>
