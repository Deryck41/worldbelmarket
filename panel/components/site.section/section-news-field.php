...
<?php
	...
	if ($_POST['submit'] == 'websiteadd') {
       // print_r($_POST);
                ...
                $newsField = R::xdispense('crm_site_news_field');
                ...
                echo '<meta http-equiv="refresh" content="0;URL='.$astedADM.'section-news-field/'.$_GET['id'].'/1305/" />';
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			<div class="personal_divisions-body">
                <?php         $fildAll = R::find('crm_site_news_field', 'forsection = ?', [$_GET['id']]);
