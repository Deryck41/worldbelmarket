<?php
/* Smarty version 3.1.45, created on 2024-03-19 08:28:46
  from '/sites/worldbelmarket.by/asted_themes/marketplace/main.acws' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.45',
  'unifunc' => 'content_65f94cbe394bd3_39394046',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b6700508ee25abc9895a1da226248a1425d0b3e8' => 
    array (
      0 => '/sites/worldbelmarket.by/asted_themes/marketplace/main.acws',
      1 => 1710836917,
      2 => 'file',
    ),
  ),
...
function content_65f94cbe394bd3_39394046 (Smarty_Internal_Template $_smarty_tpl) {
					...
					<div class="row justify-content-end">
						<div class="slider-text flex-block order-2 order-sm-1 col-sm-6 col-xl-4 col-md-6">
							...
							<h1 class="slider-title">
								<strong class="highlights-text">worldbelmarket.by</strong>
							</h1>

							<a href="/katalog/" class="btn btn-primary wd-shop-btn slider-btn">
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-4 wow fadeInLeft animated" data-wow-delay="300ms">
                <div class="message-box">
					...
					<?php echo $_smarty_tpl->tpl_vars['BLOCKP1partnerskiyblokzagolovok']->value;?>
 
                    </div>
                    <div class="message-content">
					<?php echo $_smarty_tpl->tpl_vars['BLOCKP1partnerskiybloktekst']->value;?>
 
                    </div>
                </div>
                <div class="message-bar-chart">
                    <img src="<?php echo $_smarty_tpl->tpl_vars['BLOCKP1partnerskiybloklevoeizobrazhenie']->value;?>
" class="img-fluid" alt="message-bar-chart" />
                </div>
            </div>
