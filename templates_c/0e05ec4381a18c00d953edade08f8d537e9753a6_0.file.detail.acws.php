<?php
/* Smarty version 3.1.45, created on 2024-02-05 12:11:55
  from '/Users/arturstrazhevich/Sites/marketplace.asted/asted_themes/marketplace/components/catalog/detail.acws' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.45',
  'unifunc' => 'content_65c0a65b04efa5_36688866',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0e05ec4381a18c00d953edade08f8d537e9753a6' => 
    array (
      0 => '/Users/arturstrazhevich/Sites/marketplace.asted/asted_themes/marketplace/components/catalog/detail.acws',
      1 => 1707124251,
      2 => 'file',
    ),
  ),
...
function content_65c0a65b04efa5_36688866 (Smarty_Internal_Template $_smarty_tpl) {
?>	<!-- =========================
	...
	<section class="product-details">
		<div class="container">
						...
						<div class="product-gallery col-12 col-md-12 col-lg-6">
							...
							<div class="row">
								<div class="col-md-12 product-slier-details">
									<ul id="lightSlider">
										<li data-thumb="img/shina/shina.jpg">
											<img class="figure-img img-fluid" src="img/shina/shina.jpg" data-fancybox="gallery"
						...
						<div class="col-6 col-12 col-md-12 col-lg-6">
							<div class="product-details-gallery">
								...
								<div class="list-group content-list">
									<p><i class="fa fa-dot-circle-o" aria-hidden="true"></i> 100% оригинальный продукт</p>
									<p><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Гарантия производителя</p>
								</div>
							</div>
							<div class="product-store row">
								<div class="col-12 product-store-box">
									<div class="row">
										<div class="col-3 p0 store-border-img">
											<img src="img/product-store/product-store-img1.jpg" class="figure-img img-fluid"
												alt="Product Img">
										</div>
										<div class="col-5 store-border-price text-center">
											<div class="price">
												<p><span class="asted-price">490</span> BYN</p>
											</div>
										</div>
								...
								<div class="col-12 product-store-box">
									<div class="row">
										<div class="col-3 p0 store-border-img">
											<img src="img/product-store/product-store-img2.jpg" class="figure-img img-fluid"
												alt="Product Img">
										</div>
										<div class="col-5 store-border-price text-center">
											<div class="price">
								...
								<div class="col-12 product-store-box">
									<div class="row">
										<div class="col-3 p0 store-border-img">
											<img src="img/product-store/product-store-img3.jpg" class="figure-img img-fluid"
												alt="Product Img">
										</div>
										<div class="col-5 store-border-price">
											<span class="badge badge-secondary wd-badge text-uppercase">ХИТ</span>
								...
								<div class="col-12 product-store-box">
									<div class="row">
										<div class="col-3 p0 store-border-img">
											<img src="img/product-store/product-store-img4.jpg" class="figure-img img-fluid"
												alt="Product Img">
										</div>
										<div class="col-5 store-border-price text-center">
											<div class="price">
										...
										<div class="col-4 store-border-button">
											<a href="https://www.ebay.com/" target="_blank"
												class="btn btn-primary wd-shop-btn pull-right green-bg">
												Купить сейчас
											</a>
										</div>
									</div>
								...
								<div class="col-12 product-store-box">
									<div class="row">
										<div class="col-3 p0 store-border-img">
											<img src="img/product-store/product-store-img5.jpg" class="figure-img img-fluid"
												alt="Product Img">
										</div>
										<div class="col-5 store-border-price text-center">
											<div class="price">
										...
										<div class="col-4 store-border-button">
											<a href="https://www.Elipkart.com/" target="_blank"
												class="btn btn-primary wd-shop-btn pull-right blue-bg">
												Купить сейчас
											</a>
										</div>
									</div>
							...
							<div class="tab-content" id="pills-tabContent">
								<div class="tab-pane fade active show " id="description-section" role="tabpanel"
									...
									<div class="product-tab-content">
										...
										<p class="description-subcontent">Those looking forward to an excellent trimmer at an affordable
											price will say they have found their ultimate solution in Kamei KM-2013 Trimmer. This Electric
											Hair Clipper from Kemei features in brown color with an ergonomically crafted outfit. The recharge
											time for this device is 480 minutes with the usage time of 40 minutes. You can plug and charge the
											device from a standard 220V, 50Hz power source. The technology and design assure a great trimming
											experience.</p>

										<h6 class="description-subtitle">Quality of Body and Combs</h6>
										<p class="description-subcontent">High Hardness Alloy Steel Blade. The attachment includes stubble
											comb which can suffice various applications. The device also comes with Superior lift cut
											technology which offers smooth trimming with the cutting intervals of 1 mm, 1.5 mm, 2 mm, 3 mm, 4
											mm, 5 mm, 6 mm, 7 mm, 8 mm. The number of combs is one, and the number of trim settings are </p>

										<h6 class="description-subtitle">Usability</h6>
										<p class="description-subcontent">There are no additional epilator settings. Brush cleaning is
											facilitated to clean after every use. The device can be used in cordless fashion for extra
											convenience. So you do not have to worry about moving the unit to the desired location. The handle
											grip material is made of plastic and there is a pop-up trimmer as well. The different technical
											specifications make it highly convenient to use.</p>

										<h6 class="description-subtitle">Additional features</h6>
										<p class="description-subcontent">The device features a LED display. here are no additional epilator
											settings. Brush cleaning is facilitated to clean after every use. The device can be used in
											cordless fashion for extra convenience. S The interesting aspects of the hair trimmer include a
											fantastic design that supports ease of use, <a class="highlights-text" href="#">good battery
												backup and a great blade that</a></p>
										...
										<p class="description-subcontent">Redefine your workday with the Palm Treo Pro smartphone. Perfectly
											balanced, you can respond to business and personal email, stay on top of appointments and
											contacts, and use Wi-Fi or GPS when you’re out and about. Then watch a video on YouTube, catch up
											with news and sports on the web, or listen to a few songs. Balance your work and play the way you
											like it, with the Palm Treo Pro.</p>

										<div class="row">
											<div class="col-12 col-md-12 col-lg-6">
												<ul class="description-list">
													<li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Windows Mobile® 6.1 Professional
														Edition</li>
													<li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Qualcomm® MSM7201 400MHz Processor
													</li>
													<li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> 320x320 transflective colour TFT
														touchscreen</li>
													<li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> HSDPA/UMTS/EDGE/GPRS/GSM radio</li>
													<li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Tri-band UMTS — 850MHz, 1900MHz,
														2100MHz</li>
													<li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Quad-band GSM — 850/900/1800/1900
													</li>
													<li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> 802.11b/g with WPA, WPA2, and 801.1x
														authentication</li>
													<li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Built-in GPS</li>
													<li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Bluetooth Version: 2.0 + Enhanced
														Data Rate</li>
													<li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> 256MB storage (100MB user
														available), 128MB RAM</li>
													<li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> 2.0 megapixel camera, up to 8x
														digital zoom and video capture</li>
													<li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Removable, rechargeable 1500mAh
									...
									<div class="row tab-video-area">
										...
										<div class="col-12 col-md-12 col-lg-6 video-info">
											...
											<p><strong class="video-info-subtitle">Pros:</strong>really great keyboard, good trackpad,
												alcantara, stand-out design, USB-A port, great screen, great battery life, Windows Hello</p>
											<p><strong class="video-info-subtitle">Pros:</strong>really great keyboard, good trackpad,
												alcantara, stand-out design, USB-A port, great screen, great battery life, Windows Hello</p>


											<p class="video-info-content">The device features a LED display. The interesting aspects of the
												hair trimmer include a fantastic design that supports ease of use, good battery backup and a
												great blade that performs well and lasts for so long.</p>
										</div>
									</div>
								</div>
			...
			<div class="row related-product">
				<h4 class="related-product-title">Похожие товары</h4>
					...
					<div class="col-12">
						<figure class="figure product-box">
							...
							<figcaption class="figure-caption text-center">
								...
								<div class="compare-btn">
									<a class="btn btn-primary btn-sm" href="#"><i class="fa fa-exchange" aria-hidden="true"></i> Add to
										compare</a>
								</div>
							</figcaption>
						</figure>
