            ...
            <div class="row">
                ...
                <div class="col-1">
                    <div class="personal_divisions-icon">
                        <i class="fas fa-fw fa-trash trashclick" onclick="Delete(' . $row["id"] . ',"catalog")" value="' . $row["id"] . '" style="float: right;"></i> <a href="/asted/catalog-edit/' . $row["id"] . '/"><i class="fas fa-fw fa-edit" data-toggle="modal" data-target="#myModalka' . $row["id"] . '" style="float: right;"></i></a>
                    </div>
                </div>
            </div>
        </div>
