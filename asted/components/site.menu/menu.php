            ...
            ?>
              <form action="" method="post">
                <div class="row">
                  <div class="col-lg-4">
                    <a <? if (empty($parent)) {
                          echo 'href="/asted/menu/' . $idmenu . '/podmenu/"';
                  ...
                  <div class="col-lg-4">
                    <i class="fas fa-fw fa-trash trashclick<?= $idmenu ?>" onclick="Delete(<?= $idmenu?>,'menu')" value="<?= $idmenu ?>" style="float: right;"></i> <a href="/asted/menu-edit/<?= $idmenu ?>/" style="    padding-right: 12px;"><i class="fas fa-fw fa-edit" data-toggle="modal" data-target="#myModalka<?= $id ?>" style="float: right;"></i></a>
                  </div>
