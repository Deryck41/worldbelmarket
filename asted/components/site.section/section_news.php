...
<div class="container-fluid">
  ...
  if ($userSessionDivisions == "1") {
    ...
    if ($_POST['submit'] == 'websiteadd') {
      $sql = "INSERT INTO `crm_site_section` (forwebsite, namesection, websitemodule) VALUES ('{$_GET['id']}','{$_POST['websitesectname']}', 'news')";
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">Секции новостей</h1>
    </div>
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Список секций новостей</h6>
      </div>
      <div class="card-body">
