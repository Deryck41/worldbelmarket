            ...
            ?>
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary"> <img src="<?= $lead_userAvatar ?>" style="width: 26px;border-radius: 28px; height: 26px;"> <a href="/asted/profile/<?= $usersid ?>/"><?= $usersname; ?> <?= $userssurname; ?></a>
