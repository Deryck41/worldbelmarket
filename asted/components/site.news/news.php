...
<div class="container-fluid">
    ...
    if ($_POST['submit'] == 'websiteadd') {
        ...
        if (R::store($newsAdd)) {
            echo '<meta http-equiv="refresh" content="0;URL=/asted/news/' . $_GET['id'] . '/1305/" />';
        } else {
    ...
    ?>
                <div class="container-fluid">
                    <div class="alert alert-success" role="alert">
                        Asted Cloud: Новость успешно добавлена
                    </div>
                </div>
    <? }
        }
                    ...
                    <div class="row">
                        ...
                        <div class="col-1">
                            <div class="personal_divisions-icon">
                                <i class="fas fa-fw fa-trash trashclick" onclick="Delete(<?= $id?>,'news')" value="<?= $id ?>" style="float: right;"></i> <a href="/asted/news-edit/<?= $id ?>/"><i class="fas fa-fw fa-edit" data-toggle="modal" data-target="#myModalka<?= $id ?>" style="float: right;"></i></a>
                            </div>
                        </div>
                    </div>
