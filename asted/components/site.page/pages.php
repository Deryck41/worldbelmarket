	...
	?>
				<div class="container-fluid">
					<div class="alert alert-success" role="alert">
						Asted Cloud: Страница успещно добавлена
					</div>
				</div>
	<? }
		}
...
">
						...
						<?php if ($pagetype == "code") { ?>
							<div class="alert alert-danger mb-0" style="font-size: 11px;">ВНИМАНИЕ: Данная страница имеет уникальнкую структуру дизайна и использует логический код-астед, и редактируется только через контетные блоки либо через шаблон (обратитесь к разрабочику: asted.by), при этом вы можите менять остальные значения страницы:
						<a href="/asted/content/<?=$id?>/">редактировать страницу</a>.
						</div>
						<? } ?>
					</div>
			...
			<form action="" method="post">
				...
				<select class="form-control group" name="pagetype">
					...
					<option id="zxc1" value="code">Asted - Логический код</option>
				</select>
